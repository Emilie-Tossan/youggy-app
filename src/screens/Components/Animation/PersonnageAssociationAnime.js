...
const PersonnageAssociation2 = props => {
	...
	return (
		<AnimatedSvg
			width={width}
			height={height}
			viewBox={`-${pivotX} -${pivotY} 426.748 426.75`}
		...
		C243.377,85.021,224.28,91.95,224.28,91.95z"
			...
			>
				<AnimatedPath
					transform={`translate(-${pivotX} -${pivotY})`}
					d="M238.782,221.025c14.257-22.033,28.51-44.07,42.747-66.116c0.773-1.2,1.451-1.594,2.914-1.224
			...
			>
				<AnimatedPath
					transform={`translate(-${pivotX} -${pivotY})`}
					d="M189.437,222.928c-2.469,2.182-8.94,8.321-11.365,10.292c-2.403,1.951-5.123,3.387-8.534,4.371
		...
		c-22.068,0-24.486-26.838-18.525-32.959c5.961-6.122,33.023-7.895,37.054-1.128C268.481,148.595,265.427,171.6,243.358,171.6z"
			...
			<Path
				transform={`translate(-${pivotX} -${pivotY})`}
				d="M259.196,167.524c-0.541,1.378-5.07,4.155-6.822,5.132l14.815,24.148l6.305-5.891L259.196,167.524z"
			/>
			<LinearGradient
				id="prefix__k"
				gradientUnits="userSpaceOnUse"
